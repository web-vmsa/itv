...
<head>
	<!-- Primary Meta Tags -->
	<title>ITV — Diretoria</title>
	<meta charset="utf-8">
	<meta name="title" content="ITV — Diretoria">
	...
	<meta property="og:url" content="<?php echo BASE_URL; ?>sobre/diretoria">
	<meta property="og:title" content="ITV — Diretoria">
	...
	<meta property="twitter:url" content="<?php echo BASE_URL; ?>sobre/diretoria">
	<meta property="twitter:title" content="ITV — Diretoria">
...
<body>
	...
	<div class="topo-descricao--absolute" id="topo">
		<img src="<?php echo BASE_URL; ?>assets/imgs/topo-image--diretoria.png">
		<div class="textoEdit">
			<h2>DIRETORIA</h2>
			<p>Conheça a nossa diretoria para o quinquênio (2021-2026) logo abaixo.</p>
		</div>
	</div>

	<!-- Diretoria -->
	<div class="diretoria--body">

		<div class="diretor">
			<div class="diretor--nome">
				<h4>PAULO ARRUDA - PRESIDENTE</h4>
			</div>
			<div class="diretor--info">
				<div class="diretor--img">
					<img src="<?php echo BASE_URL; ?>assets/imgs/paulo--foto.png">
				</div>
				<div class="diretor--texto">
					<p>O Dr. Paulo Arruda é o presidente e fundador do Instituto Transformando Vidas.</p>
					<p><strong>E-mail:</strong> <a href="">dr_arruda@hotmail.com</a><br>
					<strong>Contato:</strong> <a href="">(92) 98136-0011</a></p>
					<p><strong>Redes sociais:</strong>
						<a href=""><img src="<?php echo BASE_URL; ?>assets/imgs/facebook.png"></a>
						<a href=""><img src="<?php echo BASE_URL; ?>assets/imgs/instagram.png"></a>
						<a href=""><img src="<?php echo BASE_URL; ?>assets/imgs/whatsapp.png"></a>
						<a href=""><img src="<?php echo BASE_URL; ?>assets/imgs/linkedin.png"></a>
					</p>
				</div>
			</div>
		</div>
